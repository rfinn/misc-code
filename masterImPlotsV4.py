...
print 'path were plots will be saved = ',originalpath
...
path='/home/'+analyzer[prefix]+'/LocalClusters/cutouts/'+prefix+'/Finished/'
os.chdir(path)
print path
...
#for j in range(1): #used for testing    
    ...
    #write images to original directory
    outputfile=originalpath+'/'+name
    savefig(outputfile)
    #savefig('test.eps')
